...
public class Item {
	...
	//Source -> Generate Getting functions 
	...
	//convert an Item object as JSONObject instance, that frontend can recognize
	...
	//Create Item Builder instead of Item Constructor to avoid some null values
